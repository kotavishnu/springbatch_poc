...
import com.spring.etl.worker.jacksonutils.JobExecutionMixin;
import com.spring.etl.worker.jacksonutils.StepExecutionMixin;
import com.zaxxer.hikari.HikariConfig;
import com.zaxxer.hikari.HikariDataSource;

@Configuration
@PropertySource("classpath:application.properties")
public class WorkerJobInfraBeanConfig {
	...
	public DataSourceTransactionManager appDataSourceTransactionManager(DataSource dataSource) {
		DataSourceTransactionManager appDataSourceTransactionManager = new DataSourceTransactionManager(dataSource);
		return appDataSourceTransactionManager;
	}
	...
	@Bean
	public JobLauncher jobLauncher(JobRepository jobRepository, ThreadPoolTaskExecutor jobOperatorExecutor) throws Exception {
	...
	public ConsumerFactory<Integer, String> consumerFactory() {
	    Map<String, Object> configProps = new HashMap<>();
	    configProps.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "localhost:9092"); //bootstrapAddress holds address of kafka server
	    configProps.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, LongDeserializer.class);
	    configProps.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);
	    configProps.put(ConsumerConfig.GROUP_ID_CONFIG, "worker-group");
